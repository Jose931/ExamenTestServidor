...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-02-2023 a las 20:52:59
...
CREATE TABLE `examenes` (
  `id_examen` varchar(250) NOT NULL,
...
INSERT INTO `examenes` (`id_examen`, `pregunta1`, `respuesta1`, `pregunta2`, `respuesta2`, `pregunta3`, `respuesta3`, `puntuacion`) VALUES
('bspiG7iC', '¿En que año empezó la II Guerra Mundial?', '1939', '¿Cuales de estos colores forman la bandera de Alemania?', 'Rojo&Amarillo&Negro', 'Cuanto da la raíz cuadrada de 144 multiplicado por 3?', '3*3*2*2&36', 10),
('l1qeLNVa', '¿Cuales de estos elementos de la tabla periódica forman la molécula del agua?', 'Oxigeno&Hidrógeno', '¿Cuales de estos colores forman la bandera de Alemania?', 'Rojo&Amarillo&Negro', '¿En que año se descubrió América?', '1492', 10),
('XedCNqjW', '¿En que año empezó la II Guerra Mundial?', '1941', '¿Cual de los siguientes seres vivos son considerados animales?', 'Calamar&León', '¿Que lago es el mas grande del mundo?', 'Mar Caspio', 6.9),
('ZfvIBdUd', '¿Cuales de estos colores forman la bandera de Alemania?', 'Rojo&Amarillo&Negro', '¿Cual de las siguientes series es de animación?', 'Los Simpson', '¿Cual de estos músicos se dedica a hacer bandas sonoras?', 'John Williams', 7.1);
...
(19, '¿Cual de las siguientes frutas se consideran ácidas?'),
